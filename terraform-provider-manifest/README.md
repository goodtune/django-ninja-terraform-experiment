...
Terraform Provider for the *manifest* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=manifest&utm_campaign=terraform"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
* [manifest_datacenter](docs/resources/datacenter.md)
### Data Sources

* [manifest_datacenter](docs/data-sources/datacenter.md)
...
1. Execute `go build` to construct a binary called `terraform-provider-manifest`
...
provider_installation {
  ...
  dev_overrides {
      "registry.terraform.io/speakeasy/manifest" = "<PATH>"
  }
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=manifest&utm_campaign=terraform)
